...
export const HistoryCard = ({ data, isRef }) => {
  return (
    <div className="historycard">
      ...
      <div className="card-details">
        <h3>
          {data.title}
          <span className="pending">{/*data.seenStatus*/}</span>
        </h3>
        ...
        <div className="job-posting-footer">
          <ul>
            ...
            <li>
              ...
              <span> 10-Jan-2024{/*data.applyAt*/}</span>
            </li>
          </ul>
        </div>
      </div>
      {/*<div className="job-listing-btns">
        <ul className="btns">
          <li>
            <Link>
              <svg
          ...
          <li>
            <Link href={data.applyLink} target="_blank">
              Apply
            </Link>
          </li>
          <br />
          <li>
            <Link href={data.quickApplyLink} target="_blank">
              Quick Apply
            </Link>{" "}
          </li>
        </ul>
